...
void handleRoot() {
  ...
  html += "<input type='text' name='message' style=\"border-radius: 10px; font-size: 24px;\" placeholder=' Enter your message' autofocus>";
  html += "<input type='submit' value='Post' style=\"border-radius: 10px; background-color: #00cc00; color: white; font-weight: bold; font-size: 24px;\">";
  html += "<p style=\"border-radius: 10px; background-color: #404040; color: white; font-weight: bold; font-size: 24px;\"> Uptime: " + getUptime() + "</p>";
  html += "</form>";
  html += "<h2 style=\"border-radius: 10px; background-color: #404040; color: white; font-size: 36px;\"> Recent Messages:</h2>";
